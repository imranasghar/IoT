## See circuit imporving code of LED-PUSH-BUTTON-02.py
## Import and GPIO setup 
import RPi.GPIO as GPIO
import time  ## import time library 

## use arrays,linklist instead variables 
##LED_PIN_LIST = [17, 27, 22]   ## if we remove or add a LED we still use the code 
LED_PIN_LIST = [17, 27]   ## remove one LED  
